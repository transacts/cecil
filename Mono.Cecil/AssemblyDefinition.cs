...
namespace Mono.Cecil {
	...
	public sealed class AssemblyDefinition : ICustomAttributeProvider, ISecurityDeclarationProvider, IDisposable {
		...
		public bool HasCustomAttributes => custom_attributes != null
			...
			: this.GetHasCustomAttributes (main_module);
		...
		public bool HasSecurityDeclarations => security_declarations != null
			...
			: this.GetHasSecurityDeclarations (main_module);
		...
		public static AssemblyDefinition CreateAssembly (AssemblyNameDefinition assemblyName, string moduleName, ModuleKind kind) =>
			CreateAssembly (assemblyName, moduleName, new ModuleParameters { Kind = kind });
...
#if !PCL
		public static AssemblyDefinition ReadAssembly (string fileName) => ReadAssembly (ModuleDefinition.ReadModule (fileName));

		public static AssemblyDefinition ReadAssembly (string fileName, ReaderParameters parameters) => ReadAssembly (ModuleDefinition.ReadModule (fileName, parameters));
#endif

		public static AssemblyDefinition ReadAssembly (Stream stream) => ReadAssembly (ModuleDefinition.ReadModule (stream));

		public static AssemblyDefinition ReadAssembly (Stream stream, ReaderParameters parameters) => ReadAssembly (ModuleDefinition.ReadModule (stream, parameters));
